...
const slides = [{
        city: 'Blommor',
        country: 'Koarp mina blommor',
        img: 'images/blommor/krokus.jpg'
    },

    {
        city: 'Akvariefiskar',
        country:'fiskar från förkastningssjöarna!',
    ...
    {
        city: 'Våra hundar',
        country: 'Hundar som våra hälsocoacher',
        img: 'images/hundar/amadeus-21.jpg'
    },

    {
        city: 'Myter som vår kollektiva själ!',
        country: 'Sagor själslig näring!',
        img: 'images/myter/headermyth.jpg'
    },

    {
        city: 'Läkeväxter',
        country: 'Helande växter för kropp och själ.',
        img: 'images/läkeväxter/echinacea1.jpg'
    }
];
